...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col max-w-[640px] border sm:mx-[calc(50vw-320px)]">
      <div className="h-[180px] relative">
        <Image
          ...
          height={3532}
          alt="포스터"
          className="absolute w-[98%] top-[calc(-100vw*833/1252+90px)] blur-[6px] sm:top-[calc(-640px*833/1252+90px)]"
        />
        <Image
          src="/poster.jpeg"
          width={1169}
      ...
      <footer className="fixed bottom-0 z-30 bg-white border border-white">
        <a href="https://forms.gle/tpTSCtagk3QjKaS6A">
